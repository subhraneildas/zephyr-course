...
//----------------------BEFORE Lecture 6 uncomment and check for specific example or homework here-----------------------------
...
//------------------------------------Homeworks or example demos lecture 6 driver dev onwards---------------------------
#include<zephyr/drivers/sensor.h>

#define SLEEP_TIME_MS 1000

#define LED_NODE DT_ALIAS(led2)
//#define our_driver0 DT_NODE_LABEL(our_driver0)
